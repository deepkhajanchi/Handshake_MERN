...
var studentMongoRouter = require("./API/student");
var loginRouter = require("./API/login");
var jobRouter = require("./API/job");
var eventRouter = require("./API/event");
var companyRouter = require("./API/company");
...
app.use("/message-mongo", messageRouter);
...
app.get("/file/:name", (req, res) => {
  ...
  console.log("/file req.params2: " + req.params.name);
  console.log("/file req.params2: " + JSON.stringify(req.params.name));
