...
import { login, loginCompany } from "../../js/actions/fetchStudent";
...
class Login extends Component {
  ...
  render() {
    ...
    if (this.state.cookieTest && this.state.roleFlag === "/login") {
      console.log("In 1");
      redirectVar = <Redirect to="/home" />;
    } else if (
      this.state.cookieTest &&
      this.state.roleFlag === "/companyLogin"
    ) {
      console.log("In 2");
