...
function IdentityCardEdit(props) {
  ...
  const image_path = `http://172.30.0.217:3001/images/profile_pics/${studentProfile.userId}.png?${showModal}`;
...
axios.post(`http://172.30.0.217:3001/student_profile/${studentProfile._id}/upload_profile_pic`, formData, {
      headers: {
