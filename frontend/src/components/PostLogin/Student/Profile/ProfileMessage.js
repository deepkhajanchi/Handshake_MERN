...
function ProfileMessage(props) {
  ...
  const handleSubmit = (e) => {
    ...
    Axios.post(`http://172.30.0.217:3001/messages/startConversation`,formData).then(resp => {
  ...
  const handleShow = () => {
    if(messageResp.body === 'Loading'){
      ...
      let body = null;
      Axios.post(`http://172.30.0.217:3001/messages/converstion_window`,data).then(resp => {
