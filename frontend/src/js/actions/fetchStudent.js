import {
  ...
  FETCH_JOB_POSTINGS_PAGINATION,
  APPLY_STUDENT_TO_JOB,
  STUDENT_APPLIED_JOBS,
...
export const login = (data) => (dispatch) => {
  ...
  return axios
    ...
    .then((loginResponse) => {
      console.log("login resposne from actions", loginResponse.data.token);
      ...
      window.localStorage.setItem(
        "cookie",
        JSON.stringify(loginResponse.data.cookie)
      );
      window.localStorage.setItem(
        "firstName",
        JSON.stringify(loginResponse.data.firstName)
      );
      window.localStorage.setItem(
        "lastName",
        JSON.stringify(loginResponse.data.lastName)
      );
      window.localStorage.setItem(
        "username",
        JSON.stringify(loginResponse.data.username)
      );
      dispatch({
        type: LOGIN,
...
export const loginCompany = (data) => (dispatch) => {
  ...
  return axios
    ...
    .then((loginResponse) => {
      ...
      window.localStorage.setItem(
        "companyName",
        JSON.stringify(loginResponse.data.companyName)
      );
      window.localStorage.setItem(
        "username",
        JSON.stringify(loginResponse.data.username)
  ...
  return async (dispatch) => {
    ...
    try {
      axios.defaults.headers.common["authorization"] =
        "JWT " + JSON.parse(window.localStorage.getItem("token"));
...
export function fetchJobPostings() {
  return async (dispatch) => {
    ...
    var x = "JWT " + JSON.parse(window.localStorage.getItem("token"));
    console.log("abccccc", x);
    axios.defaults.headers.common["authorization"] =
      "JWT " + JSON.parse(window.localStorage.getItem("token"));
    console.log(
      "Authorization",
...
export function fetchJobPostingsPagination(payload) {
  return async (dispatch) => {
    function onSuccess(success) {
      dispatch({ type: FETCH_JOB_POSTINGS_PAGINATION, payload: success });
      return success;
    }
    function onError(error) {
      dispatch({ type: FETCH_JOB_POSTINGS_PAGINATION, payload: error });
      return error;
    }
    try {
      axios.defaults.headers.common["authorization"] =
        "JWT " + JSON.parse(window.localStorage.getItem("auth"));
      var x = "JWT " + JSON.parse(window.localStorage.getItem("auth"));
      console.log("abccccc", x);
      console.log(
        "Authorization",
      ...
      const success = await axios.post(
        backend +
          `/job-mongo/getJobPostingsPagination/?page=${payload.page}&limit=${payload.limit}`,
        payload
      );
      return onSuccess(success);
    } catch (error) {
...
export function fetchEvents(payload) {
  return async (dispatch) => {
    ...
    try {
      ...
      const success = await axios.get(
        backend +
          `/event-mongo/getEvents/?page=${payload.page}&limit=${payload.limit}`
      );
      return onSuccess(success);
    } catch (error) {
      return onError("error");
...
export function updateCompanyProfile(payload) {
  return async (dispatch) => {
    ...
    try {
      ...
      const success = await axios.post(
        backend +
          `/company-mongo/updateCompanyProfile/${
            payload.companyId + "/?filePath=" + payload.filePath
          }`,
        payload.company
      );
      return onSuccess(success);
...
export function fetchAllStudents(payload) {
  return async (dispatch) => {
    function onSuccess(success) {
      dispatch({ type: FETCH_ALL_STUDENTS, payload: success });
      return success;
    }
    function onError(error) {
    ...
    try {
      ...
      const success = await axios.get(
        backend +
          `/student-mongo/fetchAllStudents/?page=${payload.page}&limit=${payload.limit}`
      );
      return onSuccess(success);
    } catch (error) {
      return onError("error");
...
export function applytoJob(payload) {
  ...
  return async (dispatch) => {
    function onSuccess(success) {
      dispatch({
        type: APPLY_STUDENT_TO_JOB,
        payload: success.data,
      });
      return success;
    }
    function onError(error) {
      dispatch({ type: APPLY_STUDENT_TO_JOB, payload: error });
      return error;
    }
    try {
      axios.defaults.headers.common["authorization"] =
...
export function changeJobApplicationsStatus(payload) {
  console.log("In action search");
  return async (dispatch) => {
    function onSuccess(success) {
      dispatch({
    ...
    function onError(error) {
      dispatch({ type: CHANGE_JOB_APP_STATUS, payload: error });
      return error;
    }
    try {
      axios.defaults.headers.common["authorization"] =
        "JWT " + JSON.parse(window.localStorage.getItem("token"));
      const success = await axios.post(
        backend + "/job-mongo/changeJobApplicationsStatus",
        payload
      );
      return onSuccess(success);
    } catch (error) {
...
export function studentAppliedJobs(payload) {
  console.log("In action search");
  return async (dispatch) => {
    function onSuccess(success) {
      dispatch({
        type: STUDENT_APPLIED_JOBS,
        payload: success.data,
      });
      return success;
    }
    function onError(error) {
      dispatch({ type: STUDENT_APPLIED_JOBS, payload: error });
      return error;
    }
    try {
      axios.defaults.headers.common["authorization"] =
      ...
      const success = await axios.post(
        backend +
          `/student-mongo/studentAppliedJobs?page=${payload.page}&limit=${payload.limit}`,
        payload
      );
      return onSuccess(success);
    } catch (error) {
...
export function getStudentProfilePicPath(payload) {
  console.log("In action search");
  return async (dispatch) => {
    function onSuccess(success) {
    ...
    try {
      ...
      const success = await axios.post(
        backend +
          "/student-mongo/uploadFile/?studentId=" +
          payload.studentId +
...
export function companyEvents(payload) {
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const success = await axios.post(
        backend +
          `/company-mongo/companyEvents/?page=${payload.page}&limit=${payload.limit}`,
        payload
      );
      return onSuccess(success);
    } catch (error) {
...
export function companyJobs(payload) {
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      const success = await axios.post(
        backend +
          `/company-mongo/companyJobs/?page=${payload.page}&limit=${payload.limit}`,
        payload
      );
      return onSuccess(success);
    } catch (error) {
